module.exports={
  ...
  //管理员配置(暂时放这)
  root_username:'admin',
  root_password:'21232f297a57a5a743894a0e4a801fc3',
  ...
  //
  insert_fields_house:    'ID,title,sub_title,position_main,position_second,ave_price,area_min,area_max,tel,sale_time,submit_time,building_type,main_img_path,main_img_real_path,img_paths,img_real_paths,property_types,property_img_paths,property_img_real_paths,location',
